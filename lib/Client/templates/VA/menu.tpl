    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <ul class="nav navbar-nav">
                <li  class="active"><a style="color: white; font-weight: bold" href="http://localhost/whmcs/admin/addonmodules.php?m=addonmodule&controller=VAFactor">Invoices File</a></li>
