    ...
    <div class="table-title">
        <div class="row">
            ...
            <div class="col-sm-4" style="padding-top: 0px;padding-left: 91%;">
                <a href="http://localhost/whmcs/index.php?m=addonmodule&controller=VA&action=create"><button type="button" class="btn btn-info"><i></i> Add New</button></a>
            </div>
        </div>
    </div>
    <table class="table">
        ...
        {foreach $args as $key => $arg}
            <tr>
                ...
                <td>{$arg.factor_id}</td>
                <td>
                    <a href="http://localhost/whmcs/index.php?m=addonmodule&controller=VA&action=show&id={$arg.id}" class="add" title="" data-toggle="tooltip" data-original-title="Add"><span class="glyphicon glyphicon-eye-open" style="color:greenyellow"></span></a>
                    <a href="http://localhost/whmcs/index.php?m=addonmodule&controller=VA&action=edit&id={$arg.id}" class="edit" title="" data-toggle="tooltip" data-original-title="Edit"><span class="glyphicon glyphicon-pencil" style="color: darkorange"></span></a>
                    <a href="http://localhost/whmcs/index.php?m=addonmodule&controller=VA&action=destroy&id={$arg.id}" class="delete" title="" data-toggle="tooltip" data-original-title="Delete"><span class="glyphicon glyphicon-trash" style="color: red"></span></a>
                </td>
            </tr>
        {/foreach}
        </tbody>
