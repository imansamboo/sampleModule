        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li ><a style="color: white; font-weight: bold" href="http://localhost/whmcs/index.php?m=addonmodule&controller=VA&action=indexInvoices">Value Added Invoices</a></li>
                    <li ><a style="color: white; font-weight: bold" href="http://localhost/whmcs/index.php?m=addonmodule&controller=VA&action=indexInvoices">Value Added Invoices</a></li>
